...
$editUser = $id ? getUser($id) : false;
if ($id && !empty(getUser($id))) {
$page  = 'users';
$title = 'تعديل بيانات <span class="text-primary">(' . getUser($id)['username'] . ')</span>';
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <input id="username" name="username" value="<?= $editUser['username'] ?>" class="form-control border-input" type="text" required placeholder="المستخدم">
                </div>
            </div>
            <div class="form-group row">
                <div class="col-lg-4">
